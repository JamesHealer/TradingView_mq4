...
void OnTick()
{
    ...
    string url = "https://8figuretrader.com/Dashboard/datascan.php";
    char postDataArray[];
    ...
    int res = WebRequest("POST", url, NULL, NULL, timeout, postDataArray, ArraySize(postDataArray) - 1, result, headers);
...
double CalculatePeakDrawdown(int barsToCheck)
{
    ...
    if(peakEquity > 0.0) {
      ...
      drawdown = ((lowestEquity - peakEquity) / peakEquity) * 100;
    }
    return drawdown;
}
